...
@endif
<div class="container text-left col-xs-1 float-sm-left" style="border:1px solid gray; width:800px; display:inline-block;">
...
<div class="container " style="border:1px solid gray; width:800px; display:inline-block;">
    Mis Productos
    <div class="row">
...
<!-- END PRODUCT -->
   @endforeach
    ...
    <div class="row">
      <div class = "col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3">
        <h2>No has seleccionado ningun producto</h2>
      </div>
    </div>
    @endif
