...
<!-- DISENO PRODUCTO -->
      ...
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          ...
          @else
            <img class="card-img-top" src="/uploads/productos/{{ $product->image }}"  style="height: 225px; width: 100%; display: block;" alt="Thumbnail [100%x225]" data-holder-rendered="true">
          @endif
          <div class="card-body">
         <a href="{{ route('products.show', $product->id)}}">{{ $product->name }}</a> <p class="card-text">{{ $product->short}}
         </p>
